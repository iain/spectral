...
" Background & Foreground (Light variant - inverted from dark)
let s:bg         = {'gui': '#fafafa', 'cterm': '231'}
let s:bg_alt     = {'gui': '#eff0eb', 'cterm': '255'}
let s:bg_alt2    = {'gui': '#d9dbd2', 'cterm': '252'}
let s:fg_dark    = {'gui': '#a29fa0', 'cterm': '247'}
let s:fg_darker  = {'gui': '#797575', 'cterm': '243'}
let s:fg_alt     = {'gui': '#626262', 'cterm': '241'}
let s:fg_light   = {'gui': '#404040', 'cterm': '238'}
let s:fg         = {'gui': '#373431', 'cterm': '237'}

" Accent Colors (Darkened and desaturated for light background)
let s:white      = {'gui': '#ffffff', 'cterm': '231'}
let s:red        = {'gui': '#c33c67', 'cterm': '161'}
let s:orange     = {'gui': '#c36a2d', 'cterm': '166'}
let s:yellow     = {'gui': '#8c8a00', 'cterm': '100'}
let s:green      = {'gui': '#259338', 'cterm': '29'}
let s:cyan       = {'gui': '#0089a1', 'cterm': '31'}
let s:purple     = {'gui': '#6251b3', 'cterm': '61'}

" Special
let s:black      = {'gui': '#000000', 'cterm': '16'}
let s:tab_bg     = {'gui': '#f0f0f0', 'cterm': '255'}
